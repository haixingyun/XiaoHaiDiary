...
import com.joker.kit.core.designsystem.component.SpaceHorizontalSmall
import com.joker.kit.core.ui.component.loading.MiLoadingMobile
            ...
            Box(
                ...
                if (isRefreshing || isFinishing) {
                    ...
                    Canvas(
                        ...
                        val dotX =
                            cos(Math.toRadians(angle.toDouble())) * circleRadius + center.x
                        val dotY =
                            sin(Math.toRadians(angle.toDouble())) * circleRadius + center.y
